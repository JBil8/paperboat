...
links = pd.read_csv("paperboat_linksBIO-CHEM-EN-PHOTON.csv")
...
# OpenAI API key
client = openai.OpenAI(api_key= "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") #keys.OPENAI_KEY    #############
